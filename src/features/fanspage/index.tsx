...
function Fanspage() {
  ...
  return (
    <main
      className="w-full h-full relative px-[6rem] py-[5rem]"
      style={{
      ...
      <div className="relative z-10 flex justify-between">
        <div>
          <div className="w-[480px] flex flex-col gap-4">
            ...
            <span className="text-[64px] font-extrabold text-white largeText leading-[60px]">
              WHAT OUR{" "}
              <span
        ...
        <div className=" flex flex-col gap-9">
          {testimonials.map((data) => (
            <motion.div
              ...
              className={`w-[430px] cursor-pointer h-fit bg-white transform transition-all duration-200  rounded-xl px-[1rem] gap-3 flex items-start py-[1.5rem] ${
                selected === data.id &&
